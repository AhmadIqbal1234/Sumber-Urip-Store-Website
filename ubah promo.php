...
$barang = query("SELECT * FROM promo WHERE id = $id")[0];
...
<head>
    ...
    <link rel="shortcut icon" href="img/logo-light-icon.ico">
    <title>Toko Sumber Urip</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h2 class="m-0 font-weight-bold text-primary">Data Promo</h2>
                            ...
                            <div class="table-responsive">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">Deskripsi Awal :</label>
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <input type="text" class="form-control" name="des2" id="des2" required value="<?= $barang["des2"]; ?>">
                                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; TSB Admin 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
