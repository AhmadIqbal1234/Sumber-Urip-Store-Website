...
$barang = query("SELECT * FROM smartphone WHERE id = $id")[0];

//cek tombol button apakah sudah pernah ditekan atau belum
if (isset($_POST["submit"])) {
    //cek apakah data berhasil atau tidak
    if (ubah_smartphone($_POST) > 0) {
        echo "
                <script>
                alert('data berhasil');
                document.location.href = 'smartphone.php';
                </script>
                ";
    } else {
        echo "
        <script>
        alert('data gagal');
        document.location.href = 'ubah smartphone.php';
        </script>
        ";
    }
}
                            ...
                            <div class="table-responsive">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <input type="text" class="form-control" name="merek" id="merek" value="<?= $barang["merek"]; ?>">
                                    </div>
                                    <div class=" form-group">
                                        <label for="message-text" class="col-form-label">Deskripsi</label>
                                        <input type="text" class="form-control" name="deskripsi" id="deskripsi" value="<?= $barang["deskripsi"]; ?>"></input>
                                    </div>
                                    <div class=" form-group">
                                        <label for="message-text" class="col-form-label">Harga</label>
                                        <input class="form-control" name="harga" id="harga" value="<?= $barang["harga"]; ?>">
                                    </div>
                                    <div class=" form-group">
