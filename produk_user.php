<?php
// $data = file_get_contents('http://localhost:8080/182739/Admin/admin/json/json_smartphone.php');
...
if (isset($_POST["cari"])) {
    $smartphone = cari_smartphone($_POST["keyword"]);
}
...
<body>
    ...
    <div class="atf-content clearfix">
        <div class="atf-page-heading atf-size-md atf-dynamic-bg" data-stellar-background-ratio="0.3" style="background-image: url(assets/img/banner/iphone4.png); background-size:cover; background-position: center center;">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-md-6 col-12">
                        <div class="atf-page-heading-in text-center">
                            <h1 class="atf-page-heading-title">SMARTPHONE SERIES</h1>
