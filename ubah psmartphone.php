...
if (isset($_POST["submit"])) {
    ...
    if (ubah_psmartphone($_POST) > 0) {
        ...
        <script>
        alert('data gagal');
        document.location.href = 'ubah psmartphone.php';
        </script>
        ";
    }
}
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h2 class="m-0 font-weight-bold text-primary">Data Produk Unggulan</h2>
                            ...
                            <div class="table-responsive">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <input type="text" class="form-control" name="des1" id="des1" required value="<?= $barang["des1"]; ?>">
                                    </div>
                                    <div class=" form-group">
                                        <label for="message-text" class="col-form-label">Deskripsi Akhir</label>
                                        <input type="text" class="form-control" name="des2" id="des2" required value="<?= $barang["des2"]; ?>"></input>
                                    </div>
                                    <div class=" form-group">
                                        <label for="message-text" class="col-form-label">Gambar</label><br>
                                        <img src="img/<?= $barang['gambar']; ?>" width="100"><br><br>
