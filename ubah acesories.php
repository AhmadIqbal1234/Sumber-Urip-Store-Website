...
if (isset($_POST["submit"])) {
    ...
    if (ubah_acesories($_POST) > 0) {
        ...
        <script>
        alert('data gagal');
        document.location.href = 'ubah acesories.php';
        </script>
        ";
    }
}
                            ...
                            <div class="table-responsive">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <input type="text" class="form-control" name="merek" id="merek" required value="<?= $barang["merek"]; ?>">
                                    </div>
                                    <div class=" form-group">
                                        <label for="message-text" class="col-form-label">Deskripsi</label>
                                        <input type="text" class="form-control" name="deskripsi" id="deskripsi" required value="<?= $barang["deskripsi"]; ?>"></input>
                                    </div>
                                    <div class=" form-group">
